...
export function TubesBackground({
        ...
        const initTubes = async () => {
            ...
            try {
                ...
                const app = TubesCursor(canvasRef.current, {
                    tubes: {
                        colors: ["#2DD4BF", "#A3E635", "#14b8a6"], // Brand Teal, Brand Lime, Another Teal
                        lights: {
                            intensity: 200,
                            colors: ["#4ade80", "#22d3ee", "#14b8a6", "#bef264"] // Matching brand colors
                        }
                    }
                });
    ...
    const handleClick = () => {
        ...
        // Optional: Randomize colors on click, or keep brand colors
        // For now keeping randomization as per original component behavior but maybe bounded to palette could be better
        // keeping original behavior for interaction fun
