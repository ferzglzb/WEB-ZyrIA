...
// Removed manual JSX augmentation that was breaking standard HTML elements.
...
function Scene() {
  ...
  // Hardcoded Dark Mode Settings for Nebula Aurora Theme
  const themeColors = {
    dotColor: '#4ADE80', // Brand Green/Action color for dots
    bgColor: '#0E3A3A',   // Brand Petrol background
    dotOpacity: 0.2
  }
  ...
  // Ensure material is created only once
...
export const DotScreenShader = () => {
  return (
    <Canvas
      dpr={[1, 2]} // Performance: Clamp pixel ratio to max 2
